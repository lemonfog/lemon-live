...
<template>
  <div text-center py-1>
    <div class="w-60%  max-w-md pos-relative inline-block">
      <input md:text-4 type="text" v-model.trim="kw" box-border w-full py-2.5 pl-3 pr-9 text-white bg-transparent b-1
        b-green rounded-6 outline-0 @keydown.enter="goSearch" placeholder="请输入房间号或关键字">
